...
export default function Footer() {
  return (
    <>
    <footer className="bg-blue-950 text-white flex justify-between">
        <div className="w-[600px] p-10 px-32 justify-between">
        ...
        <div className="w-[600px] p-10 px-32">
      ...
      <p className="text-center bg-blue-950 text-gray-400"> &copy; 2025 SciTrade Solutions. All rights reserved.</p>
      </>
  )}